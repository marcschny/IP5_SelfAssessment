const initialDataScript = [
  ...
  'INSERT INTO Question (question_number, question, subquestion) VALUES (\'2.4.1\',\'Was ganz konkret möchtest Du in den nächsten zwei Wochen ausprobieren?\', \'Beschreibe die neue Situation und auch das neue, andere Verhalten möglichst genau.\')',
  ...
  'INSERT INTO Question (question_number, question, subquestion) VALUES (\'2.6.2\',\'Wer der Sozialpädagog*innen könnte Dir dabei helfen?\', \'Die Sozialpädagog*innen in der WG sind ja dazu da, Dich zu unterstützen. Wen willst Du einbeziehen in Dein «Ja klar, das schaff ich-»-Projekt/Vorhaben?\')',
